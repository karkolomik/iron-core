...
function FeedBackBox({ text, name, job }) {
  return (
    <div className="absolute flex flex-col bg-black  top-0 right-0 w-[60%] md1000:w-full h-full py-[25px] px-[45px] min540:py-[24px] min540:px-[30px] min540:h-[42rem] min375:h-[50rem]">
      <img alt="quote_img" src={ReviewLogo} className="w-[4rem]" />
      <p className=" text-[16px] italic text-[#dedede] my-6 ml-10 z-10 md1000:text-[11px]">
        {text}
      </p>
