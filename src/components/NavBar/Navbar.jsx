              ...
              >
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-[1.6rem] font-medium text-[#000000b1]">
                    We are a premier fitness center dedicated to helping you
                    achieve your health and wellness goals. Our gym offers a
                    wide range of state-of-the-art equipment, expert trainers,
                    and diverse workout classes to ensure you have a rewarding
                    fitness experience.
                  </p>
                </div>
                {/* gallery */}
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#ff0336] cursor-pointer ease-in duration-200">
                    ...
                    &nbsp; Business Center Coliseum, 8th Floor, Kyiv, Ukraine
                  </p>
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#ff0336] cursor-pointer ease-in duration-200">
